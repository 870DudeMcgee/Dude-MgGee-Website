...
const HIDDEN_PRODUCT_HANDLES = new Set([
  'unisex-t-shirt-1', // Digital Fauna Signal Tee - White
  'unisex-premium-mid-weight-hoodie-1', // White hoodie
]);
let cache = null;
...
async function loadFreshCatalog(request) {
  ...
  const products = data.products.nodes
    .filter(product => !HIDDEN_PRODUCT_HANDLES.has(product.handle))
